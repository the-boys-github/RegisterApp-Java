...
public class EmployeeRestController extends BaseRestController {
	...
	public @ResponseBody ApiResponse createEmployee(
		...
		this.employeeCreateCommand.setEmployee(employee)
			.setEmployee(employee)
			.setInitialEmployee(isInitialEmployee)
			.execute();
		final Employee createdEmployee = this.employeeCreateCommand.getEmployee();
